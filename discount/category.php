...
$discount = new Discount();
    if(trim($_GET["param"]) != '') {
    $category_name["p_category"] = $_GET["param"];
$result = json_decode($products::selectProductsByCategoryCustomSelect($conn, $category_name));
//echo "<pre>";
//print_r($result);
...
<ol class="breadcrumb">
  ...
  <li class="active" style="text-transform: capitalize;"><?php echo $_GET["param"]; ?></li>
...
<div class="container">
  <div class="row" id="slider-text">
    <div class="col-md-6" >
      <h2 style="text-transform: uppercase;"><?php echo $_GET["param"]; ?></h2>
    </div>
  </div>
</div>
<div class="container">
